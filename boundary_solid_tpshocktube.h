...
#ifndef __BOUNDARY_SOLID_TPSHOCKTUBE_H__
#define __BOUNDARY_SOLID_TPSHOCKTUBE_H__
 ...
 *
 */
class TPShocktube2DSolidBoundary: public Boundary {
public:
	/// constructor
	TPShocktube2DSolidBoundary();

	/// destructor
	virtual ~TPShocktube2DSolidBoundary() {}
