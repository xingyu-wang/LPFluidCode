...
Shocktube3DSolidBoundary::Shocktube3DSolidBoundary():lengthX(7), lengthY(2), lengthZ(2), thickness(0.2) {
...
int Shocktube3DSolidBoundary::operator()(double x, double y, double z, double pressure, double vx, double vy, double vz,
...
void Shocktube3DSolidBoundary::reflect(double x, double y, double z, double pressure, double vx, double vy, double vz, int bx, int by, int bz,
