...
#ifndef __BOUNDARY_SOLID_SHOCKTUBE_H__
#define __BOUNDARY_SOLID_SHOCKTUBE_H__
 ...
 *
 */
class Shocktube2DSolidBoundary: public Boundary {
public:
	/// constructor
	Shocktube2DSolidBoundary();

	/// destructor
	virtual ~Shocktube2DSolidBoundary() {}
