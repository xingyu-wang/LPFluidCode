#ifndef __BOUNDARY_SOLID_SHOCKTUBE_THREED_H__
#define __BOUNDARY_SOLID_SHOCKTUBE_THREED_H__

#include "boundary.h"
#include <vector>


class Shocktube3DSolidBoundary: public Boundary {
public:
        /// constructor
        Shocktube3DSolidBoundary();

        /// destructor
        virtual ~Shocktube3DSolidBoundary() {}
