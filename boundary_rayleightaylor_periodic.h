...
#ifndef __BOUNDARY_RT_PERIODIC_H__
#define __BOUNDARY_RT_PERIODIC_H__
 ...
 *
 */
class RayleighTaylorPeriodic2DBoundary: public Boundary {
public:
	/// constructor
	RayleighTaylorPeriodic2DBoundary();

	/// destructor
	virtual ~RayleighTaylorPeriodic2DBoundary() {}
